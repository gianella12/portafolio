...
export function Bio() {
  return (
    <motion.section
      ...
      "
    >
      <div className="rounded-2xl px-5 sm:px-8 py-8 sm:py-10 backdrop-blur">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            className="mt-6 h-px w-20 sm:w-24 origin-left bg-gradient-to-r from-violet-400 to-cyan-400"
          />
        </div>
      </div>
    </motion.section>
